 ...
 * @since 03.07.2023
 *
 * Permission: multiperms.command.permission.user.add
 * Usage: /permission user <User> add <Group | Permission> <Value>
 *
 */
        ...
        switch (arguments[3]) {
            case "group":
                ...
                if (user.getGroup().getIdentification() == group.getIdentification()) {
                    commandSender.sendMessage(this.translationProvider.getMessage(commandSender, "commands.permission.user.add.group.main-group")
                            .replaceAll("%prefix%", super.getConfiguration().getPrefix())
                ...
                if (user.getSubGroups().contains(group)) {
                    commandSender.sendMessage(this.translationProvider.getMessage(commandSender, "commands.permission.user.add.group.user-has-group")
                            .replaceAll("%prefix%", super.getConfiguration().getPrefix())
                            .replaceAll("%colored_user_name%", user.getColoredName())
                            .replaceAll("%colored_group_name%", group.getColoredDisplayName())
                            .replaceAll("%group_name%", group.getName())
                ...
                commandSender.sendMessage(this.translationProvider.getMessage(commandSender, "commands.permission.user.add.group.successfully-added")
                        .replaceAll("%prefix%", super.getConfiguration().getPrefix())
                        .replaceAll("%colored_user_name%", user.getColoredName())
                        .replaceAll("%colored_group_name%", group.getColoredDisplayName())
                        .replaceAll("%group_name%", group.getName())
            ...
            case "permission":
                if (user.hasPermission(arguments[4])) {
                    commandSender.sendMessage(this.translationProvider.getMessage(commandSender, "commands.permission.user.add.permission.user-has-permission")
                            .replaceAll("%prefix%", super.getConfiguration().getPrefix())
                            .replaceAll("%colored_user_name%", user.getColoredName())
                            .replaceAll("%user_name%", user.getName())
                ...
                commandSender.sendMessage(this.translationProvider.getMessage(commandSender, "commands.permission.user.add.permission.successfully-added")
                        .replaceAll("%prefix%", super.getConfiguration().getPrefix())
                        .replaceAll("%colored_user_name%", user.getColoredName())
                        .replaceAll("%user_name%", user.getName())
                        .replaceAll("%permission%", arguments[4]));
